import { YGDimension, YGEdge, YGMeasureMode } from './enums';
...
export class YGCachedMeasurement {
  ...
  isEqual(measurement: YGCachedMeasurement) {
    let isEqual =
      this.widthMeasureMode == measurement.widthMeasureMode && this.heightMeasureMode == measurement.heightMeasureMode;
