...
class YGLayout {
    public position: [number, number, number, number, number, number, number, number, number];
    public dimensions: [number, number];
    public margin: [number, number, number, number, number, number, number, number, number];
    public border: [number, number, number, number, number, number, number, number, number];
    public padding: [number, number, number, number, number, number, number, number, number];
    ...
    constructor() {
        ...
        this.position = [undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined]
        this.margin = [undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined];
        this.border = [undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined];
        this.padding = [undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined];
    ...
    clone(): YGLayout {
        ...
        newLayout.position = [this.position[0], this.position[1], this.position[2], this.position[3],, this.margin[5], this.margin[6], this.margin[7], this.margin[8]]
        newLayout.margin = [this.margin[0], this.margin[1], this.margin[2], this.margin[3], this.margin[4], this.margin[5], this.margin[6], this.margin[7], this.margin[8]]
        newLayout.border = [this.border[0], this.border[1], this.border[2], this.border[3], this.border[4], this.border[5], this.margin[6], this.margin[7], this.margin[8]]
        newLayout.padding = [this.padding[0], this.padding[1], this.padding[2], this.padding[3], this.padding[4], this.padding[5], this.margin[6], this.margin[7], this.margin[8]]
