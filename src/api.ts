...
import type { YGConfig } from './ygconfig';
import type { YGNode } from './ygnode';
import type { YGValue } from './ygvalue';
import {
  YGConfigFree,
  ...
  setFlexBasis(flexBasis: number | string): void {
    if (typeof flexBasis === 'string') {
      if (flexBasis[flexBasis.length - 1] === '%') {
        ...
        this.setFlexBasis(parseFloat(flexBasis));
      } else {
  ...
  setMargin(edge: YGEdge, margin: number | string): void {
    if (typeof margin === 'string') {
      if (margin === 'auto') {
        ...
        this.setMargin(edge, parseFloat(margin));
      } else {
        throw new Error('Invalid input type.');
      }
    } else {
  ...
  setMaxHeight(maxHeight: number | string): void {
    if (typeof maxHeight === 'string') {
      if (maxHeight[maxHeight.length - 1] === '%') {
        ...
        this.setMaxHeight(parseFloat(maxHeight));
      } else {
        throw new Error('Invalid input type.');
      }
    } else {
  ...
  setMaxWidth(maxWidth: number | string): void {
    if (typeof maxWidth === 'string') {
      if (maxWidth[maxWidth.length - 1] === '%') {
        ...
        this.setMaxWidth(parseFloat(maxWidth));
      } else {
        throw new Error('Invalid input type.');
      }
    } else {
  ...
  setMinHeight(minHeight: number | string): void {
    if (typeof minHeight === 'string') {
      if (minHeight[minHeight.length - 1] === '%') {
        ...
        this.setMinHeight(parseFloat(minHeight));
      } else {
        throw new Error('Invalid input type.');
      }
    } else {
  ...
  setMinWidth(minWidth: number | string): void {
    if (typeof minWidth === 'string') {
      if (minWidth[minWidth.length - 1] === '%') {
        ...
        this.setMinWidth(parseFloat(minWidth));
      } else {
        throw new Error('Invalid input type.');
      }
    } else {
  ...
  setPadding(edge: YGEdge, padding: number | string): void {
    if (typeof padding === 'string') {
      if (padding[padding.length - 1] === '%') {
        ...
        this.setPadding(edge, parseFloat(padding));
      } else {
        throw new Error('Invalid input type.');
      }
    } else {
  ...
  setPosition(edge: YGEdge, position: number | string): void {
    if (typeof position === 'string') {
      if (position[position.length - 1] === '%') {
        ...
        this.setPosition(edge, parseFloat(position));
      } else {
        throw new Error('Invalid input type.');
      }
    } else {
  ...
  setWidth(width: number | string): void {
    if (typeof width === 'string') {
      if (width[width.length - 1] === '%') {
        ...
        this.setWidth(parseFloat(width));
      } else {
        throw new Error('Invalid input type.');
      }
    } else {
